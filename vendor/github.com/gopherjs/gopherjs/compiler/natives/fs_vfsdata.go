...
var FS = func() http.FileSystem {
	fs := vfsgen۰FS{
		"/": &vfsgen۰DirInfo{
			name:    "/",
			modTime: time.Date(2018, 8, 25, 20, 5, 21, 643049340, time.UTC),
		},
		"/src": &vfsgen۰DirInfo{
			name:    "src",
		...
		"/src/crypto": &vfsgen۰DirInfo{
			name:    "crypto",
			modTime: time.Date(2018, 8, 25, 20, 5, 17, 441206554, time.UTC),
		},
		"/src/crypto/internal": &vfsgen۰DirInfo{
			name:    "internal",
			modTime: time.Date(2018, 8, 25, 20, 5, 17, 441258749, time.UTC),
		},
		"/src/crypto/internal/subtle": &vfsgen۰DirInfo{
			name:    "subtle",
			modTime: time.Date(2018, 8, 25, 20, 5, 17, 441424233, time.UTC),
		},
		"/src/crypto/internal/subtle/aliasing.go": &vfsgen۰CompressedFileInfo{
			name:             "aliasing.go",
			modTime:          time.Date(2018, 8, 25, 20, 5, 17, 441762295, time.UTC),
		...
		"/src/internal": &vfsgen۰DirInfo{
			name:    "internal",
			modTime: time.Date(2018, 8, 23, 5, 1, 24, 438836095, time.UTC),
		},
		"/src/internal/cpu": &vfsgen۰DirInfo{
			name:    "cpu",
			modTime: time.Date(2018, 8, 23, 5, 1, 24, 438419748, time.UTC),
		},
		"/src/internal/cpu/cpu_js.go": &vfsgen۰FileInfo{
			name:    "cpu_js.go",
			modTime: time.Date(2018, 8, 23, 5, 1, 24, 438709601, time.UTC),
		...
		"/src/internal/syscall": &vfsgen۰DirInfo{
			name:    "syscall",
			modTime: time.Date(2018, 8, 23, 5, 1, 24, 438889487, time.UTC),
		},
		"/src/internal/syscall/unix": &vfsgen۰DirInfo{
			name:    "unix",
			modTime: time.Date(2018, 8, 23, 5, 1, 24, 438967084, time.UTC),
		},
		"/src/internal/syscall/unix/unix_js.go": &vfsgen۰FileInfo{
			name:    "unix_js.go",
			modTime: time.Date(2018, 8, 23, 5, 1, 24, 439487083, time.UTC),
		...
		"/src/math": &vfsgen۰DirInfo{
			name:    "math",
			modTime: time.Date(2018, 8, 23, 5, 1, 24, 439737538, time.UTC),
		},
		...
		"/src/math/math.go": &vfsgen۰CompressedFileInfo{
			name:             "math.go",
			modTime:          time.Date(2018, 8, 23, 5, 1, 24, 439991642, time.UTC),
		...
		"/src/reflect": &vfsgen۰DirInfo{
			name:    "reflect",
			modTime: time.Date(2018, 8, 25, 20, 5, 21, 623808408, time.UTC),
		},
		...
		"/src/reflect/reflect.go": &vfsgen۰CompressedFileInfo{
			name:             "reflect.go",
			modTime:          time.Date(2018, 8, 23, 5, 1, 24, 440858290, time.UTC),
		...
		"/src/reflect/reflect_test.go": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2018, 8, 25, 20, 5, 21, 623943583, time.UTC),
		...
		"/src/runtime": &vfsgen۰DirInfo{
			name:    "runtime",
			modTime: time.Date(2018, 8, 25, 20, 5, 21, 602774675, time.UTC),
		},
		...
		"/src/runtime/runtime.go": &vfsgen۰CompressedFileInfo{
			name:             "runtime.go",
			modTime:          time.Date(2018, 8, 25, 20, 5, 21, 603155520, time.UTC),
		...
		"/src/strings": &vfsgen۰DirInfo{
			name:    "strings",
			modTime: time.Date(2018, 8, 23, 5, 1, 24, 442544866, time.UTC),
		},
		...
		"/src/strings/strings_test.go": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2018, 8, 23, 5, 1, 24, 442787009, time.UTC),
		...
		"/src/sync": &vfsgen۰DirInfo{
			name:    "sync",
			modTime: time.Date(2018, 8, 23, 5, 1, 24, 443014114, time.UTC),
		},
		...
		"/src/sync/waitgroup.go": &vfsgen۰CompressedFileInfo{
			name:             "waitgroup.go",
			modTime:          time.Date(2018, 8, 23, 5, 1, 24, 443598464, time.UTC),
		...
		"/src/syscall": &vfsgen۰DirInfo{
			name:    "syscall",
			modTime: time.Date(2018, 8, 23, 5, 1, 24, 443877737, time.UTC),
		},
		...
		"/src/syscall/syscall_unix.go": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2018, 8, 23, 5, 1, 24, 444143729, time.UTC),
		...
		"/src/testing": &vfsgen۰DirInfo{
			name:    "testing",
			modTime: time.Date(2018, 8, 23, 5, 1, 24, 444387543, time.UTC),
		},
		...
		"/src/testing/testing.go": &vfsgen۰CompressedFileInfo{
			name:             "testing.go",
			modTime:          time.Date(2018, 8, 23, 5, 1, 24, 444640160, time.UTC),
		...
		"/src/unicode": &vfsgen۰DirInfo{
			name:    "unicode",
			modTime: time.Date(2018, 8, 23, 5, 1, 24, 444909781, time.UTC),
		},
		"/src/unicode/unicode.go": &vfsgen۰CompressedFileInfo{
			name:             "unicode.go",
			modTime:          time.Date(2018, 8, 23, 5, 1, 24, 445176638, time.UTC),
