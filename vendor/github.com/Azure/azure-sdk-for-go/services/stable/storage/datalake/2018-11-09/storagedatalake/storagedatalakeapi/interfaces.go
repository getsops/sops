...
import (
	"context"
	"github.com/Azure/azure-sdk-for-go/services/stable/storage/datalake/2018-11-09/storagedatalake"
...
type PathClientAPI interface {
	...
	Read(ctx context.Context, filesystem string, pathParameter string, rangeParameter string, xMsLeaseID string, ifMatch string, ifNoneMatch string, ifModifiedSince string, ifUnmodifiedSince string, xMsClientRequestID string, timeout *int32, xMsDate string) (result storagedatalake.ReadCloser, err error)
