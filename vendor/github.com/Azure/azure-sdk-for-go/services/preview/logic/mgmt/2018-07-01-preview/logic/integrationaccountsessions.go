...
func (client IntegrationAccountSessionsClient) listNextResults(lastResults IntegrationAccountSessionListResult) (result IntegrationAccountSessionListResult, err error) {
