...
func (AdGroupStatusEnum_AdGroupStatus) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_ad_group_status_161ca849d0bafcf1, []int{0, 0}
}
...
func (*AdGroupStatusEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_ad_group_status_161ca849d0bafcf1, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/enums/ad_group_status.proto", fileDescriptor_ad_group_status_161ca849d0bafcf1)
}

var fileDescriptor_ad_group_status_161ca849d0bafcf1 = []byte{
