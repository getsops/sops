...
func (BudgetStatusEnum_BudgetStatus) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_budget_status_2fb46ae309df8939, []int{0, 0}
}
...
func (*BudgetStatusEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_budget_status_2fb46ae309df8939, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/enums/budget_status.proto", fileDescriptor_budget_status_2fb46ae309df8939)
}

var fileDescriptor_budget_status_2fb46ae309df8939 = []byte{
