...
func (AdGroupAdErrorEnum_AdGroupAdError) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_ad_group_ad_error_fa1468040091c755, []int{0, 0}
}
...
func (*AdGroupAdErrorEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_ad_group_ad_error_fa1468040091c755, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/errors/ad_group_ad_error.proto", fileDescriptor_ad_group_ad_error_fa1468040091c755)
}

var fileDescriptor_ad_group_ad_error_fa1468040091c755 = []byte{
