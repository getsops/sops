...
func (*HotelPerformanceView) Descriptor() ([]byte, []int) {
	return fileDescriptor_hotel_performance_view_464a53ac516511a1, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/resources/hotel_performance_view.proto", fileDescriptor_hotel_performance_view_464a53ac516511a1)
}

var fileDescriptor_hotel_performance_view_464a53ac516511a1 = []byte{
