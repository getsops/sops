...
.. code::
    ...
    stackit beta kms key-ring list --project-id PROJECT_ID --region eu01
    stackit beta kms key list --project-id PROJECT_ID --region eu01 --key-ring-id KEYRING_ID
    stackit beta kms key version list --project-id PROJECT_ID --region eu01 --key-ring-id KEYRING_ID --key-id KEY_ID
