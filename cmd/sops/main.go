...
`
	...
	cmd := &cli.Command{
		Name:      "sops",
		Usage:     "encrypted file editor with AWS KMS, GCP KMS, Azure Key Vault, age, and GPG support",
		ArgsUsage: "sops [options] file",
		Version:   version.Version,
		Authors:   []any{"CNCF Maintainers"},

		UsageText: `sops is an editor of encrypted files that supports AWS KMS, GCP, AZKV,
PGP, and Age
...
func getMasterKeys(c *cli.Command, kmsEncryptionContext map[string]*string, kmsOptionName string, pgpOptionName string, gcpKmsOptionName string, azureKvOptionName string, hcVaultTransitOptionName string, ageOptionName string) ([]keys.MasterKey, error) {
