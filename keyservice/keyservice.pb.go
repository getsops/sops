...
func (x *Key) GetAcskmsKey() *AcsKmsKey {
	if x, ok := x.GetKeyType().(*Key_AcskmsKey); ok {
		return x.AcskmsKey
	}
	return nil
}
...
type Key_AcskmsKey struct {
	AcskmsKey *AcsKmsKey `protobuf:"bytes,8,opt,name=acskms_key,json=acskmsKey,proto3,oneof"`
}
...
func (x *AcsKmsKey) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AcsKmsKey) ProtoMessage() {}

func (x *AcsKmsKey) ProtoReflect() protoreflect.Message {
	mi := &file_keyservice_keyservice_proto_msgTypes[8]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AcsKmsKey.ProtoReflect.Descriptor instead.
func (*AcsKmsKey) Descriptor() ([]byte, []int) {
	return file_keyservice_keyservice_proto_rawDescGZIP(), []int{8}
}

func (x *AcsKmsKey) GetKeyId() string {
	if x != nil {
		return x.KeyId
	}
	return ""
...
var file_keyservice_keyservice_proto_rawDesc = []byte{
	...
	0x6b, 0x6d, 0x73, 0x4b, 0x65, 0x79, 0x12, 0x2b, 0x0a, 0x0a, 0x61, 0x63, 0x73, 0x6b, 0x6d, 0x73,
	0x5f, 0x6b, 0x65, 0x79, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0a, 0x2e, 0x41, 0x63, 0x73,
	0x4b, 0x6d, 0x73, 0x4b, 0x65, 0x79, 0x48, 0x00, 0x52, 0x09, 0x61, 0x63, 0x73, 0x6b, 0x6d, 0x73,
	...
	0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x6b, 0x65, 0x79, 0x49, 0x64, 0x22, 0x22,
	0x0a, 0x09, 0x41, 0x63, 0x73, 0x4b, 0x6d, 0x73, 0x4b, 0x65, 0x79, 0x12, 0x15, 0x0a, 0x06, 0x6b,
...
var file_keyservice_keyservice_proto_depIdxs = []int32{
	...
	8,  // 7: Key.acskms_key:type_name -> AcsKmsKey
