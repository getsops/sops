...
func (x *Key) GetTencentKmsKey() *TencentKmsKey {
	if x, ok := x.GetKeyType().(*Key_TencentKmsKey); ok {
		return x.TencentKmsKey
	}
	return nil
}
...
type Key_TencentKmsKey struct {
	TencentKmsKey *TencentKmsKey `protobuf:"bytes,7,opt,name=tencent_kms_key,json=tencentKmsKey,proto3,oneof"`
}
...
func (*Key_TencentKmsKey) isKey_KeyType() {}
...
func (x *TencentKmsKey) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TencentKmsKey) ProtoMessage() {}

func (x *TencentKmsKey) ProtoReflect() protoreflect.Message {
	mi := &file_keyservice_keyservice_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TencentKmsKey.ProtoReflect.Descriptor instead.
func (*TencentKmsKey) Descriptor() ([]byte, []int) {
	return file_keyservice_keyservice_proto_rawDescGZIP(), []int{7}
}

func (x *TencentKmsKey) GetKeyId() string {
	if x != nil {
		return x.KeyId
	}
	return ""
...
var file_keyservice_keyservice_proto_rawDesc = []byte{
	...
	0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xd2, 0x02,
	...
	0x65, 0x79, 0x48, 0x00, 0x52, 0x06, 0x61, 0x67, 0x65, 0x4b, 0x65, 0x79, 0x12, 0x38, 0x0a, 0x0f,
	0x74, 0x65, 0x6e, 0x63, 0x65, 0x6e, 0x74, 0x5f, 0x6b, 0x6d, 0x73, 0x5f, 0x6b, 0x65, 0x79, 0x18,
	0x07, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x54, 0x65, 0x6e, 0x63, 0x65, 0x6e, 0x74, 0x4b,
	0x6d, 0x73, 0x4b, 0x65, 0x79, 0x48, 0x00, 0x52, 0x0d, 0x74, 0x65, 0x6e, 0x63, 0x65, 0x6e, 0x74,
	0x4b, 0x6d, 0x73, 0x4b, 0x65, 0x79, 0x42, 0x0a, 0x0a, 0x08, 0x6b, 0x65, 0x79, 0x5f, 0x74, 0x79,
	...
	0x01, 0x28, 0x09, 0x52, 0x09, 0x72, 0x65, 0x63, 0x69, 0x70, 0x69, 0x65, 0x6e, 0x74, 0x22, 0x26,
	0x0a, 0x0d, 0x54, 0x65, 0x6e, 0x63, 0x65, 0x6e, 0x74, 0x4b, 0x6d, 0x73, 0x4b, 0x65, 0x79, 0x12,
	0x15, 0x0a, 0x06, 0x6b, 0x65, 0x79, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x05, 0x6b, 0x65, 0x79, 0x49, 0x64, 0x22, 0x46, 0x0a, 0x0e, 0x45, 0x6e, 0x63, 0x72, 0x79, 0x70,
...
var file_keyservice_keyservice_proto_goTypes = []interface{}{
	...
	(*AgeKey)(nil),           // 6: AgeKey
	(*TencentKmsKey)(nil),    // 7: TencentKmsKey
...
var file_keyservice_keyservice_proto_depIdxs = []int32{
	...
	7,  // 6: Key.tencent_kms_key:type_name -> TencentKmsKey
