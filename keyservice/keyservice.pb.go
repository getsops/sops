...
func (x *Key) GetCloudruKmsKey() *CloudruKmsKey {
	if x, ok := x.GetKeyType().(*Key_CloudruKmsKey); ok {
		return x.CloudruKmsKey
	}
	return nil
}
...
type Key_CloudruKmsKey struct {
	CloudruKmsKey *CloudruKmsKey `protobuf:"bytes,7,opt,name=cloudru_kms_key,json=cloudruKmsKey,proto3,oneof"`
}
...
func (*Key_CloudruKmsKey) isKey_KeyType() {}
...
func (x *CloudruKmsKey) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CloudruKmsKey) ProtoMessage() {}

func (x *CloudruKmsKey) ProtoReflect() protoreflect.Message {
	mi := &file_keyservice_keyservice_proto_msgTypes[7]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CloudruKmsKey.ProtoReflect.Descriptor instead.
func (*CloudruKmsKey) Descriptor() ([]byte, []int) {
	return file_keyservice_keyservice_proto_rawDescGZIP(), []int{7}
}

func (x *CloudruKmsKey) GetKeyId() string {
	if x != nil {
		return x.KeyId
	}
	return ""
...
var file_keyservice_keyservice_proto_rawDesc = []byte{
	...
	0x63, 0x6c, 0x6f, 0x75, 0x64, 0x72, 0x75, 0x5f, 0x6b, 0x6d, 0x73, 0x5f, 0x6b, 0x65, 0x79, 0x18,
	0x07, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x43, 0x6c, 0x6f, 0x75, 0x64, 0x72, 0x75, 0x4b,
	0x6d, 0x73, 0x4b, 0x65, 0x79, 0x48, 0x00, 0x52, 0x0d, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x72, 0x75,
	...
	0x0a, 0x0d, 0x43, 0x6c, 0x6f, 0x75, 0x64, 0x72, 0x75, 0x4b, 0x6d, 0x73, 0x4b, 0x65, 0x79, 0x12,
...
var file_keyservice_keyservice_proto_goTypes = []any{
	...
	(*AgeKey)(nil),           // 6: AgeKey
	(*CloudruKmsKey)(nil),    // 7: CloudruKmsKey
...
var file_keyservice_keyservice_proto_depIdxs = []int32{
	...
	7,  // 6: Key.cloudru_kms_key:type_name -> CloudruKmsKey
