...
type Metadata struct {
	...
	TencentKeys               []tencentkey `yaml:"tencent_kms,omitempty" json:"tencent_kms,omitempty"`
...
type keygroup struct {
	...
	TencentKeys       []tencentkey `yaml:"tencent_kms" json:"tencent_kms"`
}
...
func internalGroupFrom(kmsKeys []kmskey, pgpKeys []pgpkey, gcpKmsKeys []gcpkmskey, hckmsKeys []hckmskey, azkvKeys []azkvkey,
	vaultKeys []vaultkey, ageKeys []agekey, tencentKeys []tencentkey) (sops.KeyGroup, error) {
